...
const LEADER_SHELL_CLASS = [
  ...
  "font-['Open_Sans']! text-[#eef1f7]! [&_*]:box-border! [&_*::before]:box-border! [&_*::after]:box-border!"
].join(' ');
...
export default function LeaderPage({ locale = 'en' }: LeaderPageProps): JSX.Element {
  ...
  return (
    <SitePageShell className={LEADER_SHELL_CLASS} ariaLabel={content.pageLabel} locale={locale} activeRoute='leader'>
      <div className='leader-wrap m-[106px_auto_60px]! max-w-[1100px]! px-[20px]! py-0! box-content! text-[#eef1f7]! max-[980px]:mt-[22px]! max-[980px]:w-full! max-[980px]:max-w-none! max-[980px]:px-[14px]! max-[980px]:box-border!'>
        <section className='leader-card grid! grid-cols-[280px_1fr]! items-[initial]! justify-[initial]! gap-[30px]! rounded-[18px]! border! border-[rgba(255,255,255,0.16)]! bg-[rgba(255,255,255,0.05)]! p-[24px]! max-[980px]:grid-cols-1! max-[640px]:gap-[16px]! max-[640px]:p-[16px]!'>
          ...
          <div>
            ...
            <a className='leader-homepage border-b! border-[rgba(255,255,255,0.5)]! font-bold! text-white! no-underline!' href='https://panhui.people.ust.hk/' target='_blank' rel='noopener noreferrer'>{content.homepageLabel}</a>
          </div>
        </section>

        <section className='leader-section mx-auto! block! max-w-[980px]!'>
