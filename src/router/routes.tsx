...
export const routes: RouteObject[] = [
  ...
  { path: '/legacy/people.html', element: <Navigate to="/people" replace /> },
  ...
  { path: '/legacy/project.html', element: <Navigate to="/project" replace /> },
  { path: '/news.html', element: <Navigate to="/news" replace /> },
  { path: '/legacy/news.html', element: <Navigate to="/news" replace /> },
  { path: '/leader.html', element: <Navigate to="/leader" replace /> },
  { path: '/legacy/leader.html', element: <Navigate to="/leader" replace /> },
  ...
  { path: '/legacy/news-japantimes-ai-love.html', element: <Navigate to="/news/japantimes-ai-love" replace /> },
  { path: '/news/nature-spotlight.html', element: <Navigate to="/news/nature-spotlight" replace /> },
  { path: '/legacy/news-mc2-nature-spotlight.html', element: <Navigate to="/news/nature-spotlight" replace /> },
  ...
  { path: '/legacy/zh/people.html', element: <Navigate to="/zh/people" replace /> },
  ...
  { path: '/legacy/zh/project.html', element: <Navigate to="/zh/project" replace /> },
  { path: '/zh/news.html', element: <Navigate to="/zh/news" replace /> },
  { path: '/legacy/zh/news.html', element: <Navigate to="/zh/news" replace /> },
  { path: '/zh/leader.html', element: <Navigate to="/zh/leader" replace /> },
  { path: '/legacy/zh/leader.html', element: <Navigate to="/zh/leader" replace /> },
  ...
  { path: '/legacy/zh/news-japantimes-ai-love.html', element: <Navigate to="/zh/news/japantimes-ai-love" replace /> },
  { path: '/zh/news/nature-spotlight.html', element: <Navigate to="/zh/news/nature-spotlight" replace /> },
  { path: '/legacy/zh/news-mc2-nature-spotlight.html', element: <Navigate to="/zh/news/nature-spotlight" replace /> },
